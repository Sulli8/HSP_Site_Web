<?php
 ...
 <html lang="en" dir="ltr">
   <head>
     <meta charset="utf-8">
     <title>Service Messagerie | Medecin </title>
 ...
 <?php include "../include/header_medecin.php"; ?>
 <?php
 require_once($_SERVER['DOCUMENT_ROOT']."/HSP_Site_Web/medico/manager/manager.php");
 $manager = new Manager();
 $id = $_SESSION['id_medecin'];
 $db = $manager->connexion_bd();
 $select = "SELECT nom,prenom,mail,image_profil from medecin WHERE id='$id'";
 $request = $db->query($select);
 $tableau = $request->fetchall();
  ?>

  <?php $destinataire = "SELECT mail from user";
   ...
   <div class="modal-dialog" role="document">
     <div class="modal-content">
       ...
       <div class="modal-body">
         <form action="../traitement/traitement_service_messagerie_medecin.php" method="post">
   ...
   <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
     <div class="modal-dialog modal-dialog-centered" role="document">
       <div class="modal-content">
         ...
         $id = $_SESSION['id_medecin'];
         $db = $manager->connexion_bd();
         $voir_message = "SELECT message_envoye from message_medecin  WHERE id_medecin='$id'";
         $btn_delete = "SELECT id from message_medecin WHERE id_medecin='$id'";
       ...
       foreach (array_unique($tab_suppression[$i]) as $key => $value) {
         echo "<a style='color:#fff;width:120px;margin-bottom:10px;margin-left:370px;'class='btn btn-primary' href='../traitement/traitement_suppression_message_medecin.php?delete=$value'>Supprimer</a>";
       }
         }
           }
           else{  ?>
           ...
           <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                   ...
                   <aside class="lg-side">
                       <div class="inbox-head">
                           <h3>Service messagerie (Médecin)</h3>
                           ...
                           <table class="table table-inbox table-hover">
                             <tbody>
                                 ...
                                 <?php   $affiche_message = $db->query("SELECT objet,message_recu,heure FROM message_medecin WHERE id_medecin='$id'");
